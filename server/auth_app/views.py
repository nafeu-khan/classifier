...
class PasswordResetRequestView(APIView):
    def post(self, request):
        try:
            ...
            return Response({'message': 'Password reset email sent. Please check your email and follow the instructions.'})
        except Exception as e:
            return Response({'error': f'Error sending password reset email: {str(e)}'}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
