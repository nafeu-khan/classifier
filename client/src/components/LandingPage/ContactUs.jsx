...
const ContactUs = () => {
  return (
    <section id="contactus" className="bg-blue-50 dark:bg-slate-800">
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div className="flex items-stretch justify-center">
            <div className="grid md:grid-cols-2">
                ...
                <div className="card h-fit max-w-6xl p-5 md:p-12 shadow-xl dark:bg-slate-900 border rounded-xl" id="form">
